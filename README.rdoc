...
##Docker
* Clone the repo
* Make a copy of database.yml.docker as database.yml
* Make a copy of .env-docker as .env and update with the correct info
* docker-compose build
* docker-compose run web rake db:create
* docker-compose run web rake db:migrate
* docker-compose up

You'll need a copy of the database for this to work correctly
