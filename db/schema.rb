...
ActiveRecord::Schema.define(version: 20210322114943) do
  ...
  create_table "submissions", force: :cascade do |t|
    ...
    t.string   "personal_details_form_file_name"
    t.string   "personal_details_form_content_type"
    t.integer  "personal_details_form_file_size"
    t.datetime "personal_details_form_updated_at"
  end
