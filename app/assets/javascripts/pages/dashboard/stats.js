...
function ($scope, $resource, SAPI_API_URL, SAPI_SPECIES_GROUPS, countryService) {
  ...
  $scope.sapi.species_title_cites = 'Number of CITES-listed species in your country by group';
  $scope.sapi.species_title_cms = 'Number of CMS-listed species in your country by group';
